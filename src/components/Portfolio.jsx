    ...
    <>
      <section className="portfolio section" id="portfolio">
        ...
        >
          ...
          <SwiperSlide className="portfolio__content grid">
            <img
              src="https://images.unsplash.com/photo-1674062325556-f2528e4a6fbb?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxlZGl0b3JpYWwtZmVlZHw4fHx8ZW58MHx8fHw%3D&auto=format&fit=crop&w=500&q=60"
              alt=""
          ...
          <SwiperSlide className="portfolio__content grid">
            <img
              src="https://images.unsplash.com/photo-1673993446290-d5bbb7e02bb1?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxlZGl0b3JpYWwtZmVlZHwzNXx8fGVufDB8fHx8&auto=format&fit=crop&w=500&q=60"
              alt=""
              className="portfolio__img"
            />
            <div className="portfolio__data">
